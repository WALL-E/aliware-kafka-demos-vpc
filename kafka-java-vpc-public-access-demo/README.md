...
KafkaClient {
  ...
  username="alikafka_pre-cn-xxxxxxxxxxx"
  password="xxxxxxxxxxxxxxxxxxxxx";
};

```

注意：其中username和password可以从消息队列kafka的实例信息中获取。
...
## 接入点，通过控制台获取
## 您在控制台获取的接入点
bootstrap.servers=111.111.111.101:9093,111.111.111.101:9094,111.111.111.101:9095
